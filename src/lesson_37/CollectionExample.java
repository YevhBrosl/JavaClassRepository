...
public class CollectionExample {
    public static void main(String[] args) {
        ...
        // boolean addAll(int index, Collection<? extend T> c) - добавляет все элементы из указанной коллекции в коллекцию, у которой был вызван метод. Вставка элементов, начиная с указанного индекса
        list.addAll(listA);
        ...
        // boolean removeAll(Collection c) - удаляет все элементы из текущей коллекции, которые содрежатся в указанной коллекции
