...
import static lesson_10.MethodsExample.printArray;
...
public class MethodOverloading {
    ...
    private static void fillArray(int[] ints, int bound) {
...
//            }
    ...
    public static void printNumber(String string, int digit) {
