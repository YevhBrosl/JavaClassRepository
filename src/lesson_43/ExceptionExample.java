...
public class ExceptionExample {
    public static void main(String[] args) {
        ...
        // catch блок - для перехвата и обработки исключения
        ...
        try {
            ...
            System.out.println("I catch NPE!!!");
    ...
    private static String getUrlString() {
        URL myUrl = null;
        String defaultUrlString = "https://example.com";
    ...
    private static String getUrlString2() throws MalformedURLException {
        // Ключевое слово throws - используется в сигнатуре методадля указания,
